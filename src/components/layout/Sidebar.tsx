...
export function Sidebar() {
  ...
  const navItems = [
    { section: "Student", items: [
      ...
      { name: "Coding Log", path: "/student/coding", icon: Code },
      { name: "Activities", path: "/student/activities", icon: Award },
      { name: "Career Path", path: "/student/career", icon: TrendingUp },
    ]},
    ...
    { section: "Parent", items: [
      ...
      { name: "Child Progress", path: "/parent/progress", icon: Eye },
  ...
  return (
    <aside className="w-64 border-r border-ink/10 bg-paper-light flex flex-col min-h-screen shrink-0">
